...
$string['description'] = 'Prikažite datoteko (mm) z miselnim vzorcem';
$string['showdescription'] = 'Prikažem opis?';
$string['width'] = 'Širina';
$string['height'] = 'Višina';
$string['widthdescription'] = 'Določite širino (v pikslih). Pustite prazno, če želite uporabiti privzeto širino 450 px.';
$string['heightdescription'] = 'Določite višino (v pikslih). Pustite prazno, če želite uporabiti privzeto višino 300 px.';
?>